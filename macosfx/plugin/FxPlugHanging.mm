//#import "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/System/Library/Frameworks/AppKit.framework/Versions/C/Headers/AppKitDefines.h"
//
//  OpenExternalPlugIn.m
//  OpenExternal
//
...
#import "FxPlugHanging.h"
#import <IOSurface/IOSurfaceObjC.h>
#import "../shaders/TileableRemoteBrightnessShaderTypes.h"
#import "MetalDeviceCache.h"

#include <string>

@implementation FxPlugHanging
{
...
- (nullable instancetype)initWithAPIManager:(id<PROAPIAccessing>)newApiManager;
{
    ...
    if (self != nil)
    {
        ...
        bundle_id_ = [[[NSBundle mainBundle] bundleIdentifier] UTF8String];
    }
    return self;
}
...
- (BOOL)addParametersWithError:(NSError**)error
{
    ...
    [paramAPI startParameterSubGroup:@"Input"
                         parameterID:8000
